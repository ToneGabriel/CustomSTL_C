...
static BASIC_STRING_NAME                    _C_PUBLIC_MEMBER(BASIC_STRING_NAME, substr)(BASIC_STRING_NAME* target, size_t pos, size_t len);                                                                           \
                                                                                                                                                                                                                      \
/* Comparators */                                                                                                                                                                                                     \
static int                                  _C_PUBLIC_MEMBER(BASIC_STRING_NAME, compare)(const BASIC_STRING_NAME* str1, const BASIC_STRING_NAME* str2);                                                               \
static int                                  _C_PUBLIC_MEMBER(BASIC_STRING_NAME, compare_substr)(const BASIC_STRING_NAME* str1, size_t pos1, size_t len1, const BASIC_STRING_NAME* str2, size_t pos2, size_t len2);    \
static int                                  _C_PUBLIC_MEMBER(BASIC_STRING_NAME, compare_cstr)(const BASIC_STRING_NAME* str, const CHAR_TYPE* cstr);                                                                   \
static int                                  _C_PUBLIC_MEMBER(BASIC_STRING_NAME, compare_subcstr)(const BASIC_STRING_NAME* str, size_t pos, size_t len, const CHAR_TYPE* cstr, size_t subpos, size_t sublen);          \
                                                                                                                                                                                                                      \
/* Finders */                                                                                                                                                                                                         \
static size_t                               _C_PUBLIC_MEMBER(BASIC_STRING_NAME, find_cstr)(const BASIC_STRING_NAME* str, const CHAR_TYPE* cstr, size_t pos);                                                          \
static size_t                               _C_PUBLIC_MEMBER(BASIC_STRING_NAME, find_subcstr)(const CHAR_TYPE* cstr, size_t pos, size_t len);                                                                         \
static size_t                               _C_PUBLIC_MEMBER(BASIC_STRING_NAME, find_char)(const CHAR_TYPE chr, size_t pos);                                                                                          \
                                                                                                                                                                                                                      \
/* PRIVATE Helpers */                                                                                                                                                                                                 \
...
static int _C_PUBLIC_MEMBER(BASIC_STRING_NAME, compare)(const BASIC_STRING_NAME* str1, const BASIC_STRING_NAME* str2)                                                                                                 \
{                                                                                                                                                                                                                     \
    _C_CUSTOM_ASSERT(NULL != str1, "String 1 is NULL");                                                                                                                                                               \
    _C_CUSTOM_ASSERT(NULL != str2, "String 2 is NULL");                                                                                                                                                               \
    return _C_PUBLIC_MEMBER(CHAR_TYPE_TRAITS_NAME, substr_compare)( _C_PRIVATE_MEMBER(BASIC_STRING_NAME, cget_ptr)(str1), 0, str1->_size,                                                                             \
                                                                    _C_PRIVATE_MEMBER(BASIC_STRING_NAME, cget_ptr)(str2), 0, str2->_size);                                                                            \
}                                                                                                                                                                                                                     \
                                                                                                                                                                                                                      \
static int _C_PUBLIC_MEMBER(BASIC_STRING_NAME, compare_substr)(const BASIC_STRING_NAME* str1, size_t pos1, size_t len1, const BASIC_STRING_NAME* str2, size_t pos2, size_t len2)                                      \
{                                                                                                                                                                                                                     \
    _C_CUSTOM_ASSERT(NULL != str1, "String 1 is NULL");                                                                                                                                                               \
    _C_CUSTOM_ASSERT(NULL != str2, "String 2 is NULL");                                                                                                                                                               \
    return _C_PUBLIC_MEMBER(CHAR_TYPE_TRAITS_NAME, substr_compare)( _C_PRIVATE_MEMBER(BASIC_STRING_NAME, cget_ptr)(str1), pos1, len1,                                                                                 \
                                                                    _C_PRIVATE_MEMBER(BASIC_STRING_NAME, cget_ptr)(str2), pos2, len2);                                                                                \
}                                                                                                                                                                                                                     \
                                                                                                                                                                                                                      \
static int _C_PUBLIC_MEMBER(BASIC_STRING_NAME, compare_cstr)(const BASIC_STRING_NAME* str, const CHAR_TYPE* cstr)                                                                                                     \
{                                                                                                                                                                                                                     \
    _C_CUSTOM_ASSERT(NULL != str, "String is NULL");                                                                                                                                                                  \
    _C_CUSTOM_ASSERT(NULL != cstr, "CString is NULL");                                                                                                                                                                \
    return _C_PUBLIC_MEMBER(CHAR_TYPE_TRAITS_NAME, substr_compare)( _C_PRIVATE_MEMBER(BASIC_STRING_NAME, cget_ptr)(str), 0, str->_size,                                                                               \
...
{                                                                                                                                                                                                                     \
    _C_CUSTOM_ASSERT(NULL != str, "String is NULL");                                                                                                                                                                  \
    _C_CUSTOM_ASSERT(NULL != cstr, "CString is NULL");                                                                                                                                                                \
    return _C_PUBLIC_MEMBER(CHAR_TYPE_TRAITS_NAME, substr_compare)( _C_PRIVATE_MEMBER(BASIC_STRING_NAME, cget_ptr)(str), pos, len,                                                                                    \
                                                                    cstr, subpos, sublen);                                                                                                                            \
}                                                                                                                                                                                                                     \
                                                                                                                                                                                                                      \
static size_t _C_PUBLIC_MEMBER(BASIC_STRING_NAME, find_cstr)(const BASIC_STRING_NAME* str, const CHAR_TYPE* cstr, size_t pos)                                                                                         \
{                                                                                                                                                                                                                     \
    ...
    _C_CUSTOM_ASSERT(NULL != str, "String is NULL");                                                                                                                                                                  \
    _C_CUSTOM_ASSERT(NULL != cstr, "CString is NULL");                                                                                                                                                                \
    return _C_PUBLIC_MEMBER(CHAR_TRAITS_NAME_PREFIX, substr_find)();                                                                                                                                                  \
}                                                                                                                                                                                                                     \
                                                                                                                                                                                                                      \
static size_t _C_PUBLIC_MEMBER(BASIC_STRING_NAME, find_subcstr)(const CHAR_TYPE* cstr, size_t pos, size_t len)                                                                                                        \
{                                                                                                                                                                                                                     \
