...
{                                                                                                                                    \
    _C_CUSTOM_ASSERT(NULL != target, "List Iterator is NULL");                                                                       \
    _C_CUSTOM_ASSERT(target->_node != target->_list->head, "Cannot increment end iterator.");                                        \
...
{                                                                                                                                    \
    _C_CUSTOM_ASSERT(NULL != target, "List Iterator is NULL");                                                                       \
    _C_CUSTOM_ASSERT(target->_node != target->_list->head->next, "Cannot decrement begin iterator.");                                \
...
{                                                                                                                                    \
    _C_CUSTOM_ASSERT(NULL != target, "List Iterator is NULL");                                                                       \
    _C_CUSTOM_ASSERT(target->_node != target->_list->head, "Cannot dereference end iterator.");                                      \
...
static bool _C_PUBLIC_MEMBER(LIST_CONST_ITERATOR_NAME, is_begin)(LIST_CONST_ITERATOR_NAME* target)                                   \
{                                                                                                                                    \
    return target->_node == target->_list->head->next;                                                                               \
}                                                                                                                                    \
                                                                                                                                     \
static bool _C_PUBLIC_MEMBER(LIST_ITERATOR_NAME, is_begin)(LIST_ITERATOR_NAME* target)                                               \
{                                                                                                                                    \
...
static bool _C_PUBLIC_MEMBER(LIST_CONST_ITERATOR_NAME, is_end)(LIST_CONST_ITERATOR_NAME* target)                                     \
{                                                                                                                                    \
    return target->_node == target->_list->head;                                                                                     \
}                                                                                                                                    \
                                                                                                                                     \
static bool _C_PUBLIC_MEMBER(LIST_ITERATOR_NAME, is_end)(LIST_ITERATOR_NAME* target)                                                 \
{                                                                                                                                    \
...
{                                                                                                                                                               \
    ...
    _C_PRIVATE_MEMBER(LIST_NAME, remove_node)(target, target->head->prev);                                                                                      \
}                                                                                                                                                               \
                                                                                                                                                                \
static void _C_PUBLIC_MEMBER(LIST_NAME, pop_front)(LIST_NAME* target)                                                                                           \
{                                                                                                                                                               \
    _C_CUSTOM_ASSERT(NULL != target, "List is NULL");                                                                                                           \
    if (0 == target->size) return;                                                                                                                              \
    _C_PRIVATE_MEMBER(LIST_NAME, remove_node)(target, target->head->next);                                                                                      \
}                                                                                                                                                               \
                                                                                                                                                                \
static LIST_ITERATOR_NAME _C_PUBLIC_MEMBER(LIST_NAME, insert_at_iterator)(LIST_NAME* target, LIST_CONST_ITERATOR_NAME* where)                                   \
{                                                                                                                                                               \
