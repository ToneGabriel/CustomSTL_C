...
{                                                                                                       \
    return (STACK_NAME){                                                                                \
        ._vec = _C_CUSTOM_TYPE_PUBLIC_MEMBER_CREATE(STACK_VECTOR_HELPER_NAME)()                         \
    };                                                                                                  \
}                                                                                                       \
                                                                                                        \
DECLARE_CUSTOM_TYPE_PUBLIC_MEMBER_DESTROY(STACK_NAME)                                                   \
...
{                                                                                                       \
    _C_CUSTOM_ASSERT(NULL != target, "Stack is NULL");                                                  \
    return _C_PUBLIC_MEMBER(STACK_VECTOR_HELPER_NAME, element_back_const)(&target->_vec);               \
}                                                                                                       \
